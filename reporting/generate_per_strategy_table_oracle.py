...
# CONFIGURATION
# ==============================================================================
RANKS_CSV = Path("paradigm_aggregations_oracle/matrix_split_average_ranks.csv")
NORM_SCORES_CSV = Path("paradigm_aggregations_oracle/matrix_split_norm_scores.csv")
SUMMARY_CSV = Path("leaderboards/matrix.csv")
OUTPUT_TEX = Path("tex/paradigm_results_oracle.tex")
